            ...
            <div class="input-field">
                <form action="listarProfessor.php" method="GET" id="frmBuscaCompet" class="col s12" >
                    <div class="input-field col s12">
                        <input type="text" placeholder="Informe o Nome do Professor:"
            ...
            ?>
                <tr> 
                    ...
                    <td> <a class="btn-floating btn-small waves-effect waves-light orange" 
                          onclick="JavaScript:location.href='frmEdtProfessor.php?id=' +
                          <?php echo $prof['id'];?>" >
                    <i class="material-icons">edit</i></a></td>
                    <td> <a class="btn-floating btn-small waves-effect waves-light red" 
                          onclick="JavaScript:location.href='frmRmvProf.php?id=' +
                          <?php echo $prof['id'];?>" >
