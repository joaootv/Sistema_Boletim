            ...
            <div class="input-field">
                <form action="listarCurso.php" method="GET" id="frmBuscaCompet" class="col s12" >
                    <div class="input-field col s12">
                        <input type="text" placeholder="Informe o Nome do Curso:"
            ...
            ?>
                <tr> 
                    ...
                    <td> <a class="btn-floating btn-small waves-effect waves-light orange" 
                          onclick="JavaScript:location.href='frmEdtCurso.php?id=' +
                          <?php echo $cursos['id'];?>" >
                    <i class="material-icons">edit</i></a></td>
                    <td> <a class="btn-floating btn-small waves-effect waves-light red" 
                          onclick="JavaScript:location.href='frmRmvCurso.php?id=' +
                          <?php echo $cursos['id'];?>" >
