        ...
        <form action="CLASSES/remCurso.php" method="POST" id='frmRmvCurso' class="col s12">
            <div class="row">
                <div class="col s10">
                    ...
                    <label for="lblNome"><h4>Nome do Curso:  <?php echo $turma['nome_c']?> </h4><label>
                    <label for="lblVagas"><h4>Vagas:  <?php echo $turma['qtd_vagas']?> </h4><label>
                    <label for="lblVagas"><h4>Qtd. de alunos inscrito:  <?php echo $qtd?> </h4><label>
                </div>
            </div>
