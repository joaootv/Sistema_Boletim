            ...
            <div class="input-field">
                <form action="listarAluno.php" method="GET" id="frmBuscaCompet" class="col s12" >
                    <div class="input-field col s12">
                        <input type="text" placeholder="Informe o Nome do Aluno para ser Selicionado"
        ...
        <table class="striped indigo lighten-4 indigo lighten-5 ">
            ...
            ?>
                <tr> 
                    ...
                    <td> <a class="btn-floating btn-small waves-effect waves-light grey darken-4" 
                          onclick="JavaScript:location.href='Boletim.php?id=' +
                          <?php echo $aluno['RA'];?>" >
                    <i class="material-icons">view_headline</i></a></td>
                    <td> <a class="btn-floating btn-small waves-effect waves-light  orange accent-3" 
                          onclick="JavaScript:location.href='frmEdtAluno.php?id=' +
                          <?php echo $aluno['RA'];?>" >
                    <i class="material-icons">edit</i></a></td>
                    <td> <a class="btn-floating btn-small waves-effect waves-light red" 
                          onclick="JavaScript:location.href='frmRmvAluno.php?id=' +
                          <?php echo $aluno['RA'];?>" >
