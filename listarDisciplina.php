            ...
            <div class="input-field">
                <form action="listarDisciplina.php" method="GET" id="frmBuscaCompet" class="col s12" >
                    <div class="input-field col s12">
                        <input type="text" placeholder="Informe o Nome da Disciplina:"
            ...
            ?>
                <tr> 
                    ...
                    <td> <a class="btn-floating btn-small waves-effect waves-light orange" 
                          onclick="JavaScript:location.href='frmEdtDisc.php?id=' +
                          <?php echo $disc['id'];?>" >
                    <i class="material-icons">edit</i></a></td>
                    <td> <a class="btn-floating btn-small waves-effect waves-light red" 
                          onclick="JavaScript:location.href='frmRmvDisc.php?id=' +
                          <?php echo $disc['id'];?>" >
