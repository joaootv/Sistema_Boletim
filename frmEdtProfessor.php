...
<body>
            ...
            <div class="row">
                <form action="CLASSES/edtProf.php" method="POST" id="frmEdtProf" class="col s12">
                   ...
                   <div class="input-field col s8">
                    ...
                    <div class="input-field col s8">
                        ...
                        <input type="text" class="form-control" id="txtNome" name="txtCpf" value="<?php echo $cpf?>">
                    </div>
                    <div class="input-field col s8">
                    ...
                    <div class="input-field col s8">
                        ...
                        <input type="text" class="form-control" id="txtCelular" name="txtCelular" maxlength="15" autocomplete="off"  value="<?php echo $celular?>">
                    </div>
                    <div class="input-field col s8">
