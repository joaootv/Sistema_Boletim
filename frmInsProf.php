...
<body>
    ...
    <div class="container  indigo lighten-5 ">
        <div class="row">
            <form action="CLASSES/insProfessor.php" method="POST" id="frmInsProfessor" class="col s12">
                ...
                <div class="input-field col s8">
                    ...
                    <input id="icon_prefix" oninput="mascara(this)" type="text" name="txtCpf" class="form-control cpf-mask"  maxlength="14"  placeholder="Ex: 000.000.000-00" autocomplete="off">
                </div>
                <div class="input-field col s8">
                ...
                <div class="input-field col s8">
                    ...
                    <input type="text" class="form-control" id="txtCelular" name="txtCelular"  placeholder="Ex: (00) 00000-0000" maxlength="15" autocomplete="off">
                </div>
                <div class="input-field col s8">
