<?php //frmRmvCompetidor.php
    ...
    $sql = "SELECT * FROM professor WHERE id=?;"; //o ? indica um argumento para o sql
...
<head>
    ...
    <title>Removeção Professor</title>
</head>
<body>
        <h3 class="grey-text text-darken-3">Remover Professor</h3>
        <div class="container  indigo lighten-5">
        <form action="CLASSES/remProf.php" method="POST" id='frmRmvProf' class="col s12">
            <div class="row">
                <div class="col s10">
                    <label for="lblId"><h4><blockquote>ID: <?php echo $id?></blockquote></h4></label>
                    <input type="hidden" id="id" name="id" value="<?php echo $id;?>">
                    <label for="lblVagas"><h4>CPF:  <?php echo $dados['cpf']?> </h4><label>
                    <label for="lblNome"><h4>Professor(a):  <?php echo $dados['nome_p']?> </h4><label> 
                </div>
            </div>
