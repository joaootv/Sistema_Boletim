        ...
        <form action="CLASSES/remDisc.php" method="POST" id='frmRmvDisc' class="col s12">
            <div class="row">
                <div class="col s10">
                    ...
                    <label for="lblNome"><h4>Disciplina:  <?php echo $nome?> </h4><label>
                    <label for="lblNome"><h4>Professor:  <?php echo $profN?> </h4><label>
                    <label for="lblVagas"><h4>Curso:  <?php echo $cursoN?> </h4><label>
                </div>
            </div>
